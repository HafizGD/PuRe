...
class _RecentScreenState extends State<RecentScreen> {
  ...
  Future<void> _loadRecents() async {
    final recentsList = await AppPreferences.getRecents();
    setState(() {
      recents = recentsList;
    });
  }
  ...
  void _toggleHint(
    ...
    final localPosition =
        renderBox != null ? renderBox.globalToLocal(position) : position;
    setState(() {
  ...
  List<Widget> _buildNewsCards(List<News> newsList) {
    final total = newsList.length;
    return List.generate(total, (index) {
      final news = newsList[index];
      final hintId = 'recent-$index';
      return Padding(
        padding: EdgeInsets.only(bottom: index == total - 1 ? 0 : 12),
        child: _RecentNewsTile(
          news: news,
          index: index + 1,
          total: total,
          ...
          onBookmark: widget.onBookmark != null ? () => widget.onBookmark!(news) : null,
                    ...
                    child: recents.isEmpty
                        ? const Center(
                            child: Padding(
                              ...
                              child: Text(
                                'Belum ada berita yang baru dibaca.',
                                style: TextStyle(
                                  color: Color(0xFF757575),
                                  fontSize: 16,
                                ),
...
// News tile widget sama seperti main menu
class _RecentNewsTile extends StatefulWidget {
  final News news;
  final int index;
  final int total;
  ...
  @override
  State<_RecentNewsTile> createState() => __RecentNewsTileState();
}

class __RecentNewsTileState extends State<_RecentNewsTile> {
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: [
                  ...
                  // Validation badge - centang hijau dengan angka valid, di atas
